        ...
        body: Column(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                selected: false,
                title: Text(
                  "info@tailoredscaffolding.com",
                  style: TextStyle(
                      letterSpacing: 0.0, fontSize: 16.0, color: Colors.black),
                ),
                onTap: () async {
                  const emailaddress =
                      'mailto:info@tailoredscaffolding.com?subject=Sample Subject&body=This is a Sample email for Tailored Scaffolding';
              ...
              ListTile(
                ...
                selected: false,
                title: Text(
                  "jason.bacon01@btinternet.com",
                  style: TextStyle(
                      letterSpacing: 0.0, fontSize: 16.0, color: Colors.black),
                ),
                onTap: () async {
                  const jasonemailaddress =
                      'mailto:jason.bacon01@btinternet.com?subject=Sample Subject&body=This is a Sample email for Jason Bacon';
